      ...
      <el-col :lg="20" :xs="24">
        ...
        <el-card shadow="hover">
          ...
          <el-table v-loading="loading" border :data="processInstanceList" @selection-change="handleSelectionChange">
            ...
            <el-table-column :show-overflow-tooltip="true" prop="flowName" align="center" label="流程定义名称" width="120px" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column v-if="tab === 'running'" align="center" prop="isSuspended" label="状态" min-width="90px">
              <template #default="scope">
                <el-tag v-if="!scope.row.isSuspended" type="success">激活</el-tag>
                <el-tag v-else type="danger">挂起</el-tag>
              </template>
            </el-table-column>
            <el-table-column align="center" label="流程状态" min-width="90px">
              <template #default="scope">
                <dict-tag :options="wf_business_status" :value="scope.row.flowStatus"></dict-tag>
              </template>
            </el-table-column>
            <el-table-column align="center" prop="createTime" label="启动时间" width="140px"></el-table-column>
              ...
              <template #default="scope">
                <el-row :gutter="10">
                  <el-col :span="1.5" v-if="scope.row.flowStatus === 'draft' || scope.row.flowStatus === 'cancel' || scope.row.flowStatus === 'back'">
                    <el-button type="primary" link size="small" icon="Edit" @click="handleOpen(scope.row, 'update')">编辑</el-button>
                  </el-col>
                  <el-col :span="1.5" v-if="scope.row.flowStatus === 'draft' || scope.row.flowStatus === 'cancel' || scope.row.flowStatus === 'back'">
                    <el-button type="primary" link size="small" icon="Delete" @click="handleDelete(scope.row)">删除</el-button>
                  </el-col>
                </el-row>
                <el-row :gutter="10">
                  <el-col :span="1.5">
                    <el-button type="primary" link size="small" icon="View" @click="handleOpen(scope.row, 'view')">查看</el-button>
                  </el-col>
                  <el-col :span="1.5" v-if="scope.row.flowStatus === 'waiting'">
                    <el-button type="primary" link size="small" icon="Notification" @click="handleCancelProcessApply(scope.row.businessId)"
                      >撤销</el-button
                    >
                  </el-col>
                </el-row>
